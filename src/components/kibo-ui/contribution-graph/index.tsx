// oxlint-disable unicorn/no-new-array unicorn/prefer-spread unicorn/no-array-reduce react/no-object-type-as-default-prop
"use client";
...
export const ContributionGraphLegend = ({
  ...
  return (
    ...
    >
      ...
      {/* @ts-expect-error - works */}
      {new Array(maxLevel + 1).fill().map((_, level) =>
        children ? (
